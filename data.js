window.CONSTITUTIONAL_WATCH_DATA = {
  ...
  participation: {
    ...
    accessControl: {
      ...
      setupNotes: [
        "검토자 또는 운영자 등록은 서버에 설정된 초대코드가 있어야 열립니다.",
        "등록 시에는 표시 이름, 권한, 초대코드를 입력한 뒤 패스키를 생성합니다.",
        "이후 로그인은 같은 별칭으로 패스키 인증만 수행하면 됩니다.",
        "패스키와 세션은 브라우저 로컬 키가 아니라 서버 세션과 감사 로그로 추적됩니다."
      ]
    },
    categories: [
      "언론 자유",
    ...
    publicRules: [
      ...
      "동적 배포에서는 공유 저장소와 서버 감사 로그를 사용하며, Postgres가 연결되면 다중 사용자 상태를 공용 DB에 기록합니다."
    ],
    anonymousBoard: {
      rules: [
